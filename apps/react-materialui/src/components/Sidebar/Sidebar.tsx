...
const structure = [
  ...
  { id: 7, label: "Media types", link: "/app/mediatypes", icon: <TableIcon /> },
  { id: 8, type: "divider" },
  { id: 9, type: "title", label: "HELP" },
  { id: 10, label: "Service Stack", link: "https://flatlogic.com/templates", icon: <LibraryIcon /> },
  { id: 11, label: "Chinook", link: "https://flatlogic.com/templates", icon: <LibraryIcon /> },
  { id: 12, label: "React", link: "https://flatlogic.com/templates", icon: <LibraryIcon /> },
  { id: 13, label: "Auth0", link: "https://flatlogic.com/templates", icon: <LibraryIcon /> },
  // {
  //   id: 1,
  //   label: "Typography",
  //   link: "/app/typography",
